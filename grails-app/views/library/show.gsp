...
<html>
    ...
    <body>
        ...
        <div id="show-library" class="content scaffold-show" role="main">
            ...
            <f:display bean="library" />
            <g:form resource="${this.library}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.library}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
